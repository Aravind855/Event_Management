        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              ...
              {/* Event Venue */}
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">Event Venue</label>
                <input
                  type="text"
                  value={eventVenue}
              ...
              {/* Event Cost */}
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">Event Cost</label>
                <input
                  type="number"
                  value={eventCost}
              ...
              <div>
               ...
               <div>
                ...
                <button
                  ...
                  className="mt-3 px-4 py-2 bg-purple-500 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-purple-600 transition duration-300"
                >
